    ...
    handleSave: function handleSave(editor) {
      ...
      if (editor) {
        ...
        if (_this.fileExt == '.jade'){
          ...
          _this.compile(editor.getURI()).then(function (_jade, options) {
        ...
        _this.jadeCode = loophole.allowUnsafeNewFunction(function() {
          return loophole.allowUnsafeEval(function() {
            ...
            try {
              ...
              atom.notifications.addWarning(err.message, {dismissable: true});
            }

          });
        });
        if (fn){
          fn(_this.jadeCode, options);
        }
        if (cb)
          cb(_this.jadeCode, options);
      });
